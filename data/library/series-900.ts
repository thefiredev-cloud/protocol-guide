  ...
  },
  {
    ...
    sections: [
      ...
      { type: "accordion", title: "Comprehensive Curriculum", items: [
        ...
        { title: "Airway Management", content: "Advanced airway techniques including endotracheal intubation, video laryngoscopy, supraglottic airways, surgical airways, difficult airway algorithms, ventilator management, capnography." },
