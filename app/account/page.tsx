    ...
    <div className="flex flex-col min-h-screen bg-[var(--background)] pb-28">
      ...
      <div className="pt-16 pb-4 px-5 max-w-md mx-auto w-full">
        <header className="flex justify-between items-center">
          ...
          <button
            type="button"
            className="w-10 h-10 rounded-full bg-[var(--surface)] border border-[var(--border)] flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-sm"
      ...
      <main className="px-5 max-w-md mx-auto w-full">
        ...
        <div className="bg-[var(--surface)] rounded-2xl p-5 shadow-sm border border-[var(--border)] mb-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700 grid grid-cols-2 gap-4">
            <div className="text-center p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50">
              <p className="text-[10px] uppercase tracking-wider text-[var(--text-secondary)] font-semibold mb-1">
                Employee ID
              </p>
        ...
        <div className="mb-8">
          ...
          <div className="bg-[var(--surface)] rounded-2xl shadow-sm border border-[var(--border)] overflow-hidden divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <MenuItem
              ...
              badge="CONNECTED"
              rightContent={
                <FolderSync size={20} className="text-[var(--text-secondary)]" />
              }
            />
            <MenuItem
              icon={
        ...
        <div className="mb-8">
          ...
          <div className="bg-[var(--surface)] rounded-2xl shadow-sm border border-[var(--border)] overflow-hidden divide-y divide-gray-100 dark:divide-gray-700">
            <MenuItem
              icon={
                <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-[var(--text-secondary)]">
                  <Moon size={20} />
                </div>
              }
              title="Appearance"
        ...
        <div className="flex flex-col items-center">
          <button
            ...
            className="text-red-600 dark:text-red-400 font-semibold text-sm py-3 px-6 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors w-full bg-[var(--surface)] border border-red-100 dark:border-red-900/30 shadow-sm flex items-center justify-center gap-2"
          >
            <LogOut size={18} />
            Log Out
          </button>
          <p className="mt-6 text-[11px] text-[var(--text-secondary)] text-center leading-relaxed">
